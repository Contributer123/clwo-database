...
$cmd_request_state_sixty_minutes = "SELECT ShortName, MapDisplayName, COUNT(MapDisplayName) FROM `snapshots` WHERE ClientCount > 5  GROUP BY MapDisplayName, ShortName HAVING COUNT(MapDisplayName) > 5 ORDER BY ShortName, COUNT(MapDisplayName) DESC";
