...
function print_data() {
	...
	Object.keys(global_map_data).forEach(function(map_name) {
		...
		content += "<div class='valign-wrapper col xl2 l3 m4 s5' onclick='render_map_data(\"" + map_name+"\", " + global_map_data[map_name].length +");'>";
			...
			content += "<img onerror=\"this.src='https://image.gametracker.com/images/maps/160x120/nomap.jpg'\" onclick='render_map_data(\"" + map_name+"\", " + global_map_data[map_name].length +");' id='image_container_" + map_name +"' src='https://image.gametracker.com/images/maps/160x120/csgo/" + map_name + ".jpg' id='preview'/>";
